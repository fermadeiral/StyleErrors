...
public abstract class RepositoryStub {
     ...
     * is, the <code>Session</code> object returned by {@link javax.jcr.Repository#login(javax.jcr.Credentials)}
     ...
     * is, the <code>Session</code> object returned by {@link javax.jcr.Repository#login()}
    ...
    /**
     * Returns a {@link java.security.Principal} identifiying a known user (not group)
     * @param session
     */
