...
/**
 * Contribution items for the Go Back command
 * @author BREDEX GmbH
 *
 */
public class NavGoBackContributionItem extends AbstractNavContributionItem {

    @Override
    protected SortedMap<Integer, String> getItems() {
        return JBNavigationHistory.getInstance().getContribItems(true, false);
    }

    @Override
    protected String getCommID() {
        return RCPCommandIDs.GO_BACK;
    }
}
