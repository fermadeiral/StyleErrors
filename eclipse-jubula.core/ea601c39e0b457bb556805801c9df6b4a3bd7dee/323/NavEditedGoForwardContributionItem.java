...
/**
 * Contribution items for the Next Edited Editor command
 * @author BREDEX GmbH
 */
public class NavEditedGoForwardContributionItem
        extends AbstractNavContributionItem {

    @Override
    protected SortedMap<Integer, String> getItems() {
        return JBNavigationHistory.getInstance().getContribItems(false, true);
    }

    @Override
    protected String getCommID() {
        return RCPCommandIDs.EDITED_GO_FORWARD;
    }
