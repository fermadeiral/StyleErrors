...
/**
 * Implementation of {@link ModelValidator} that always
 * returns true. Useful for unit testing or other scenarios
 * in which model validation is not required.
 * 
 * @author Mountain Fog, Inc.
 *
 */
public class NoOpModelValidator implements ModelValidator {
